...
#if you want to extract all the dataset entities you need to change all the 'MET' to 'DATA' and change the path_to_model and also in the store_datasetname_in_mongo function change the label field to 'dataset'
def get_NEs(res):
