...
if __name__ == "__main__":
    description = (
        'Script to query CORE datasets. Papers fetched in query will be stored in metadata.json file and multiple fulltext json files containing the paper fulltexts.')
    ...
    topics = [#'Computer Science - Sound', 'Computer Science - General Literature',
              ...
              # 'Computer Science - Computer Vision and Pattern Recognition', 'Computer Science - Numerical Analysis',
              # 'Computer Science - Discrete Mathematics', 'Computer Science - Computer Science and Game Theory',
              'Computer Science - Information Retrieval', 'Computer Science - Social and Information Networks']
              # 'Computer Science - Graphics', 'Computer Science - Emerging Technologies',
              # 'Computer Science - Formal Languages and Automata Theory', 'Computer Science - Performance',
              ...
              # 'Computer Science - Other Computer Science', 'Computer Science - Learning',
              # 'Computer Science - Multimedia', 'Computer Science - Robotics', 'Computer Science - Digital Libraries',
              # 'Computer Science - Operating Systems', 'Computer Science - Systems and Control',
              # 'Computer Science - Programming Languages', 'Computer Science - Computers and Society',
              # 'Computer Science - Computational Geometry', 'Computer Science - Computation and Language',
